...
sudo apt-get --yes --no-install-recommends install vim-nox git gitk git-gui tig tmux autojump zsh firefox vlc network-manager-openvpn-gnome network-manager-openvpn python3-pip htop scrot xautolock flameshot silversearcher-ag
